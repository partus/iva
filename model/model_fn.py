...
def build_model(is_training, inputs, params):
    ...
    """
    videovectors = inputs['videovectors']
    ...
    with tf.variable_scope('w_out'):
        logits = tf.layers.dense(out, params.num_labels,activation=None,use_bias=False)
...
def model_fn(mode, inputs, params, reuse=False):
    ...
    for label in range(0, params.num_labels):
        ...
        incorrect_image_label = tf.boolean_mask(inputs['videovectors'], mask_label)
